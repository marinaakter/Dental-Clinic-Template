          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <h2 className="font-heading text-2xl md:text-3xl font-semibold text-navy mb-2">
                {clientInfo.successModal.title}
              </h2>
              <p className="font-body text-navy/70">
                {clientInfo.successModal.description}
              </p>
            </div>
            ...
            <div className="space-y-4 bg-pearl rounded-2xl p-6">
              {appointmentData?.doctorName && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-body text-xs text-navy/50 uppercase tracking-wider">{clientInfo.successModal.labels.doctor}</p>
              ...
              {appointmentData?.serviceName && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-body text-xs text-navy/50 uppercase tracking-wider">{clientInfo.successModal.labels.service}</p>
              ...
              {appointmentData?.date && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-body text-xs text-navy/50 uppercase tracking-wider">{clientInfo.successModal.labels.date}</p>
              ...
              {appointmentData?.timeSlot && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-body text-xs text-navy/50 uppercase tracking-wider">{clientInfo.successModal.labels.time}</p>
            ...
            <div className="mt-6 p-4 bg-gold/10 rounded-xl flex items-center gap-3">
              ...
              <div>
                <p className="font-body text-sm text-navy">
                  {clientInfo.successModal.contactPrompt}{" "}
                  <a href={clientInfo.brand.phoneHref} className="text-gold font-medium hover:underline">
            ...
            >
              {clientInfo.successModal.doneLabel}
            </Button>

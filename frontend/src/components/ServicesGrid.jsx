      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        ...
        >
          <span className="font-body text-xs uppercase tracking-widest text-gold mb-4 block">
            {clientInfo.servicesGrid.eyebrow}
          </span>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-semibold text-navy leading-tight">
              {clientInfo.servicesGrid.titlePrefix} <span className="text-gold">{clientInfo.servicesGrid.titleAccent}</span>
            </h2>
            {!showAll && (
              <Link
                to="/services"
              ...
              >
                {clientInfo.servicesGrid.viewAllLabel}
            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  >
                    {clientInfo.servicesGrid.bookButtonLabel}

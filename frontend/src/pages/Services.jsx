          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
            ...
            >
              <span className="font-body text-xs uppercase tracking-widest text-gold mb-4 block">
                {clientInfo.servicesPage.hero.eyebrow}
              </span>
              <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-semibold text-navy leading-tight mb-6">
                {clientInfo.servicesPage.hero.titlePrefix} <span className="text-gold">{clientInfo.servicesPage.hero.titleAccent}</span>
              </h1>
              <p className="font-body text-navy/70 text-base md:text-lg leading-relaxed">
                {clientInfo.servicesPage.hero.description}
              </p>
                    ...
                    <div className="grid md:grid-cols-2 h-full">
                      ...
                      <div className="p-6 md:p-8 flex flex-col justify-center">
                        ...
                        <Link to={`/appointment?service=${service.id}`}>
                          ...
                          >
                            {clientInfo.servicesPage.card.buttonLabel}
                            <ArrowRight size={16} />
                          </Button>
                        </Link>
                      </div>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 text-center">
            ...
            >
              <h2 className="font-heading text-3xl sm:text-4xl font-semibold text-pearl mb-4">
                {clientInfo.servicesPage.cta.titlePrefix} <span className="text-gold">{clientInfo.servicesPage.cta.titleAccent}</span>?
              </h2>
              <p className="font-body text-pearl/70 mb-8 max-w-xl mx-auto">
                {clientInfo.servicesPage.cta.description}
              </p>
              <Link to="/appointment">
                <Button
                ...
                >
                  {clientInfo.servicesPage.cta.buttonLabel}
                </Button>
              </Link>
            </motion.div>
          </div>

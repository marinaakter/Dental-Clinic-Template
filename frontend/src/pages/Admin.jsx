    ...
    <div className="min-h-screen bg-pearl" data-testid="admin-dashboard">
      ...
      <header className="bg-navy sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <h1 className="font-heading text-xl text-pearl">
            {clientInfo.adminPage.titlePrefix} <span className="text-gold">{clientInfo.adminPage.titleAccent}</span>
          </h1>
          <Button
          ...
          >
            <LogOut size={16} />
            {clientInfo.adminPage.logoutLabel}
          </Button>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          {clientInfo.adminPage.stats.map((stat, index) => (
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gold/10 overflow-hidden">
          <div className="p-6 border-b border-gold/10">
            <h2 className="font-heading text-xl font-semibold text-navy">
              {clientInfo.adminPage.appointmentsTitle}
            </h2>
          </div>
